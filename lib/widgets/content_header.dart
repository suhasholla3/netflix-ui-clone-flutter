      ...
      child: Stack(
        ...
        children: [
          AspectRatio(
            ...
            child: _videoController.value.initialized ? VideoPlayer(_videoController): Image.asset(widget.featuredContent.imageUrl,
            fit: BoxFit.cover,),
          ),
          Positioned(
            left: 0,
                ...
                Row(
                  children: [
                    ...
                    FlatButton.icon(
                        ...
                        onPressed: () => print('More Info'), icon: const Icon(Icons.info_outline,size: 30.0), label: const Text('More Info',style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600),
                    ),),
                    const SizedBox(width: 20.0),
                    if (_videoController.value.initialized)
                      IconButton(
                          icon: Icon(
                            _isMuted ? Icons.volume_off : Icons
                                .volume_up,
                          ),
                          color: Colors.white,
                        iconSize: 30.0,
...
class _PlayButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlatButton.icon(
        ...
        onPressed: () => print('Play'), icon: const Icon(Icons.play_arrow, size: 30.0,), label: const Text(
